...
return [
    ...
    'processing' => [
        'plugins' => [
            'prooph.link.monitor.process_log_listener' => 'prooph.link.monitor.process_log_listener',
        ]
    ],
    'service_manager' => [
        'factories' => [
            ...
            'prooph.link.monitor.process_log_listener' => 'Prooph\Link\Monitor\ProcessingPlugin\Factory\ProcessLogListenerFactory',
        ]
    ],
    'controllers' => [
        'factories' => [
